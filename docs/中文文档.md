...
friends:
  -
    nickname: tools # 友链名称
    avatar: /images/friends/tool.jpeg # 友链头像
    site: https://tool.lu/ # 友链地址
    meta: 主题作者 # 友链介绍
    show: true # 是否展示此友链
```
...
```yml
friends_avatar_cdn: "https://xxx.com/static"
```
